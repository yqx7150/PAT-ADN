...
class ADNTester(Tester):
    def __init__(self, **params):
        ...
        #imageio.imwrite('/home/lqg/桌面/adn-master/runs/nature_image/img_low.jpg'，img_low)
    ...
    def get_metric(self, metric):#wei diao yong
        def measure(x, y):
            x = self.dataset.to_numpy(x, False) #False        
            y = self.dataset.to_numpy(y, False)#False  
            x = x * 0.5 + 0.5
            y = y * 0.5 + 0.5           
            return metric(x, y, data_range=1.0)
        return measure

    def get_pairs(self):#wei diao yong
        if hasattr(self.model, 'mask'):
            ...
            #self.model.img_low.save('/home/lqg/桌面/adn-master/runs/nature_image/img_low.jpg')
            #self.model.img_high.save('/home/lqg/桌面/adn-master/runs/nature_image/img_high.jpg')
            #self.model.pred_lh .save('/home/lqg/桌面/adn-master/runs/nature_image/pred_lh.jpg')
        #return img_low#,img_high,pred_lh
